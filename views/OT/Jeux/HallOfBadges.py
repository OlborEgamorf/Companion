...
from companion.tools.outils import connectSQL, dictOptions, listeOptionsJeux
...
def viewBadges(request,option):
    ...
    ctx={"badges":badges,"levels":(103,102,101,13,12,11,3,2,1),
        "avatar":user_avatar,"id":user.id,"nom":user_name,"ot":True,"pagestats":True,
        "guildname":"Olbor Track - Mondial","guildid":"ot/jeux",
        "command":"badges","options":listeOptionsJeux,"option":option,"plus":"","travel":False,"selector":True}    

    return render(request, "companion/OT/Badges.html", ctx)

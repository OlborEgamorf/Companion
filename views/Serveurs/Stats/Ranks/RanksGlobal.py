...
from companion.tools.outils import (connectSQL, dictOptions, getMoisAnnee,
                                    ...
                                    tableauMois)
from companion.views.Serveurs.Stats.Recap import getRanks
from django.contrib.auth.decorators import login_required
from django.shortcuts import render


def ranksGlobalJeux(request):
    return viewRanksGlobal(request,"OT")

@login_required(login_url="/login")
@CompanionStats
def viewRanksGlobal(request,guild):
    ...
    for option in liste:
        ...
        try:
            ...
            allRanks[option]=getRanks(request,guild,option,"",curseur=curseur,curseurGet=curseurGet,moisDB=moisDB,anneeDB=anneeDB,curseurGuild=curseurGuild)
        except:
            continue
